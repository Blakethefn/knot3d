"""Background worker for unknotting searches."""
...
class UnknottingWorker(QtCore.QObject):
    """Run the depth-1 unknotting search in a worker thread."""
    ...
    def run(self) -> None:
        ...
        try:
            result = self.engine.run_unknotting_search(
